...
export function Paginator({ url, paginator }) {
            ...
            <ul className="pagination">
                ...
                {paginator.number == 0 ||
                    <li className="page-item">
                        <Link className="page-link" to={`${url}${paginator.number - 1}`}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-chevron-double-left" viewBox="0 0 16 16">
